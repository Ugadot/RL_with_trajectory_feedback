...
class RPPendulumEnv(InvertedPendulumEnv):
    def __init__(self, Pendulum_args):
        super(RPPendulumEnv, self).__init__()
        ...
        if Pendulum_args.reward_pred or Pendulum_args.online_training:
            ...
            self.RP = Predictor(threshold = 4,  # TODO: add to arguments?
                                ...
                                wandb_name=Pendulum_args.wandb)
    ...
    def step(self, a):
        ...
        #ob, reward, done, _ = super(RPPendulumEnv, self).step(uniform_step)

        prev_ob = self._get_obs()

        ob, reward, done, _ = super(RPPendulumEnv, self).step(a)
    ...
    def reset_model(self):
        ...
        self.first_pos = None
        self.nsteps = 0
        return super(RPPendulumEnv, self).reset_model()
